...
module.exports = async function (callback) {
    try {
        ...
        caseTracker.addCase(matchingID.caseID, matchingID.itemID, "CHECKEDIN", new Date().toISOString());
